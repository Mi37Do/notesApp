<template>
    <div class="w-full h-10 relative overflow-hidden flex items-center">
        <input v-model="searchQuery" :class="searchQuery ? 'pl-10' : 'pl-3'" type="text" placeholder="Recherche" class="pixa-input w-full transition-all duration-200
                ">
